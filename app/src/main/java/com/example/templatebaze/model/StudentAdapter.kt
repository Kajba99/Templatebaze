...
import com.example.templatebaze.MainActivity
import com.example.templatebaze.R
...
class StudentHolder(inflater: LayoutInflater, parent : ViewGroup?, val context : Context )
    ...
    init {
        ...
        tvGlazba   = itemView.findViewById(R.id.tvGlazba)
    ...
    override fun onClick( v: View? ) {
        ...
        act.etGlazba.setText( student.glazba )
